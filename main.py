...
logging.basicConfig(filename='log/diablo_blackhat.log', level=logging.DEBUG,
                    format='%(asctime)s - %(levelname)s - %(message)s')


def run_flask():
    print("[DEBUG] Starting Flask dashboard...")
    telegram_notifier.send_telegram_message("🚦 Flask dashboard starting...")
...
def init_defense():
    print("[DEBUG] Starting defense modules...")
...
def init_stealth():
    print("[DEBUG] Starting stealth modules...")
...
def init_earning():
    print("[DEBUG] Starting earning modules...")
...
def init_wallet_ops():
    print("[DEBUG] Starting wallet modules...")
